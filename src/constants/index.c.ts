...
// export const ADMINROUTE = [
//     { href: '/v1/dashboard', label: 'Dashboard', value: 'dashboard' },
//     { href: '/v1/campsites', label: 'Manage Campsites', value: 'campsites' },
//     { href: '/v1/bookings', label: 'Booking Management', value: 'bookings' },
//     { href: '/v1/users', label: 'User Management', value: 'users' },
//     { href: '/v1/reviews', label: 'Reviews and Ratings', value: 'reviews' },
//     { href: '/v1/settings', label: 'Settings', value: 'settings' },
// ] as const;
